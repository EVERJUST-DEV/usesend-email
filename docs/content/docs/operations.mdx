...
<Cards>
<Card title="Getting Started" href="/quickstart">Base URL, auth, and your first send.</Card>
<Card title="Domains" href="/domains">Verifying sending domains and DNS records.</Card>
</Cards>
