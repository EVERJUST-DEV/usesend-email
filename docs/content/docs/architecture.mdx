...
<Callout type="info">
One AWS deployment serves every product. Tenancy is logical: a **Team** is a tenant, with its own sending domains and API keys. See [Tenant isolation](/tenant-isolation) for how Teams keep products apart on shared infrastructure.
</Callout>
...
<Cards>
  <Card title="Operations" href="/operations">Deploying, updating, and monitoring this instance.</Card>
  <Card title="Tenant isolation" href="/tenant-isolation">How Teams keep products separated on shared infrastructure.</Card>
</Cards>
