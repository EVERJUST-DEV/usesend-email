...
<Cards>
  <Card title="Sending email" href="/docs/sending-email">Send single and batch emails, schedule, cancel, and track status.</Card>
  <Card title="Domains" href="/docs/domains">Register sending domains, verify DNS, and read DKIM/SPF/DMARC state.</Card>
  <Card title="Contacts" href="/docs/contacts">Manage contact books, contacts, and campaigns (broadcasts).</Card>
  <Card title="Webhooks" href="/docs/webhooks">Receive delivery events and verify their HMAC signatures.</Card>
</Cards>
