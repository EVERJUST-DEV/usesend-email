...
<Callout type="info">
Standing up a new product instead? See [Onboard a product](/onboard-a-product) to create a Team, verify a domain, and mint an API key.
</Callout>
