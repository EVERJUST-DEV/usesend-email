...
<Cards>
  <Card title="Teams & API Keys" href="/docs/teams-api-keys">How Teams and us_ keys are provisioned per product.</Card>
  <Card title="Domains" href="/docs/domains">Verifying and binding sending domains to a Team.</Card>
  <Card title="Suppressions" href="/docs/suppressions">Team-scoped bounce, complaint, and unsubscribe handling.</Card>
</Cards>
